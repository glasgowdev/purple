...
namespace Purple.Bitcoin.Features.Wallet.Tests
{
    public class WalletSyncManagerTest : LogsTestBase
    {
        ...
        public WalletSyncManagerTest()
        {
            ...
            this.chain = new ConcurrentChain(Network.PurpleMain);
        ...
        {
            var result = WalletTestsHelpers.GenerateForkedChainAndBlocksWithHeight(5, Network.PurpleMain, 2);
        ...
        {
            this.chain = WalletTestsHelpers.GenerateChainWithHeight(3, Network.PurpleMain);
        ...
        {
            this.chain = WalletTestsHelpers.GenerateChainWithHeight(1, Network.PurpleMain);
