...
namespace Purple.Bitcoin.Features.BlockStore.Tests
{
    public class BlockRepositoryTest : TestBase
    {
        ...
        public void InitializesGenBlockAndTxIndexOnFirstLoad()
        {
            ...
            using (var repository = this.SetupRepository(Network.PurpleMain, dir))
            {
            }
            ...
            using (var engine = new DBreezeEngine(dir))
            {
                ...
                Assert.Equal(Network.PurpleMain.GetGenesis().GetHash(), blockRow.Value);
