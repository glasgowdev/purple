...
namespace Purple.Bitcoin.Features.BlockStore.Tests.LoopTests
{
    /// <summary>
    ...
    internal class FluentBlockStoreLoop : IDisposable
    {
        ...
        internal FluentBlockStoreLoop WithConcreteRepository(string dataFolder)
        {
            ...
            this.BlockRepository = new BlockRepository(Network.PurpleMain, this.dataFolder, DateTimeProvider.Default, this.loggerFactory.Object);
            return this;
        }
