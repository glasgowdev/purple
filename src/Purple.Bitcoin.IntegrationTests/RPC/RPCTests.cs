...
namespace Purple.Bitcoin.IntegrationTests.RPC
{
    /// <summary>
    /// Purple test fixture for RPC tests.
    /// </summary>
    public class RpcTestFixturePurple : RpcTestFixtureBase
    {
        /// <inheritdoc />
        protected override void InitializeFixture()
        {
            this.Builder = NodeBuilder.Create();
            this.Node = this.Builder.CreatePurplePowNode();
    ...
    public class RpcTests : IClassFixture<RpcTestFixturePurple>
    {
        private readonly RpcTestFixturePurple rpcTestFixture;

        public RpcTests(RpcTestFixturePurple RpcTestFixture)
        {
