...
using Purple.Bitcoin.Features.Wallet.Validations;

namespace Purple.Bitcoin.Features.Wallet.Models
{
    ...
    /// </summary>
    /// <seealso cref="Purple.Bitcoin.Features.Wallet.Models.RequestModel" />
