...
namespace Purple.Bitcoin.Configuration
{
    ...
    public class NodeSettings
    {
        ...
        /// </summary>
        /// <param name="name">Blockchain name. Currently only "bitcoin" and "Purple" are used.</param>
        ...
        public NodeSettings(string name = "bitcoin", Network innerNetwork = null, ProtocolVersion protocolVersion = SupportedProtocolVersion, string agent = "PurpleBitcoin")
        {
        ...
        /// <summary>Blockchain name. Currently only "bitcoin" and "Purple" are used.</summary>
        ...
        public NodeSettings LoadArguments(string[] args)
        {
            ...
            {
                this.DataDir = this.CreateDefaultDataDirectories(Path.Combine("PurpleNode", this.Name), this.Network);
            }
        ...
        public static bool PrintHelp(string[] args, Network mainNet)
        {
            ...
            if (args != null && args.Length == 1 && (args[0].StartsWith("-help") || args[0].StartsWith("--help")))
            {
                ...
                builder.AppendLine(" dotnet exec <Purple.PurpleD/BitcoinD.dll> [arguments]");
                builder.AppendLine();
