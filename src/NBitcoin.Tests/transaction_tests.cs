...
namespace NBitcoin.Tests
{
    public class transaction_tests
    {
        public transaction_tests()
        {
            ...
            // which include the initializers for Purple.
        ...
        public void CanGuessRedeemScriptWithInputKeys()
        {
            ...
            BitcoinAddress address = k.PubKey.WitHash.GetAddress(Network.PurpleMain);
        ...
        public void CanPartiallySignTransaction()
        {
            ...
            var scriptAddress = redeem.Hash.GetAddress(Network.PurpleMain);
