namespace NBitcoin.Tests
{
    public class alert_tests
    {
        ...
        public void CanParseAlertAndChangeUpdatePayloadAndSignature()
        {
            ...
            Assert.True(alert.CheckSignature(Network.PurpleMain));
            ...
            Assert.True(alert.CheckSignature(Network.PurpleMain));
            alert.UpdatePayload();
            Assert.False(alert.CheckSignature(Network.PurpleMain));
            Key key = new Key();
        ...
        public void AlertApplies()
        {
            ...
            {
                Assert.True(alert.CheckSignature(Network.PurpleMain));
                Assert.True(!alert.CheckSignature(Network.PurpleTest));
