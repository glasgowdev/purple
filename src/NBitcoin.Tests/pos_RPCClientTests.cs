...
namespace NBitcoin.Tests
{
    ...
    public class pos_RPCClientTests
    {
        ...
        //        builder.StartAll();
        //        Key key = new Key();
        //        rpc.ImportAddress(key.PubKey.GetAddress(Network.PurpleMain), TestAccount, false);
        ...
        //        var network = ((string)test[1]) == "Main" ? Network.PurpleMain : Network.PurpleMain;
         ...
         * TODO: Consider importing to FN.
            ...
            using (var builder = NodeBuilderPurple.Create())
            {
                ...
                using(var node = nodeA.CreateNodeClient())
                {
                    ...
                    var peers = rpc.GetPurplePeersInfoAsync().Result;
