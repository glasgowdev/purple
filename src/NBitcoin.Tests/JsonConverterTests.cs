...
namespace NBitcoin.Tests
{
    public class JsonConverterTests
    {
        ...
        public void CanSerializeInJson()
        {
            ...
            CanSerializeInJsonCore(k.PubKey.GetAddress(Network.PurpleMain));
            CanSerializeInJsonCore(new KeyPath("1/2"));
            CanSerializeInJsonCore(Network.PurpleMain);
            ...
            CanSerializeInJsonCore(new Key().PubKey.WitHash.GetAddress(Network.PurpleMain));
            CanSerializeInJsonCore(new Key().PubKey.WitHash.ScriptPubKey.GetWitScriptAddress(Network.PurpleMain));
