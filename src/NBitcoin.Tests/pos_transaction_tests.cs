...
namespace NBitcoin.Tests
{
    public class pos_transaction_tests
    {
        ...
        {
            // These tests should be using the Purple network.
        ...
        private ChainedBlock CreateBlock(DateTimeOffset now, int offset, ChainBase chain = null)
        {
            ...
            if (chain != null)
            {
                ...
                return new ChainedBlock(b.Header, b.Header.GetHash(Network.PurpleMain.NetworkOptions), chain.Tip);
            }
            else
                return new ChainedBlock(b.Header, b.Header.GetHash(Network.PurpleMain.NetworkOptions), 0);
        }
        ...
        public void CanExtractTxOutDestinationEasily()
        {
            ...
            var secret = new BitcoinSecret("VHqBm5xVQvosc7u4dDwMmzbr8mL4KzZBn5VgqjunovgURtXBo5cV", Network.PurpleMain);
        ...
        public void CanBuildStealthTransaction()
        {
            ...
            var darkSatoshi = new BitcoinStealthAddress(scanKey.PubKey, stealthKeys.Select(k => k.PubKey).ToArray(), 2, new BitField(3, 5), Network.PurpleMain);
        ...
        {
            return RandomCoin(amount, receiver.PubKey.GetAddress(Network.PurpleMain));
        }
        ...
        public void CanEstimatedFeesCorrectlyIfFeesChangeTransactionSize()
        {
            ...
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 1), new TxOut("0.00010000", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Network.PurpleMain))).ToScriptCoin(redeem));
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 2), new TxOut("0.00091824", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Network.PurpleMain))).ToScriptCoin(redeem));
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 3), new TxOut("0.00100000", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Network.PurpleMain))).ToScriptCoin(redeem));
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 4), new TxOut("0.00100000", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Network.PurpleMain))).ToScriptCoin(redeem));
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 5), new TxOut("0.00246414", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Network.PurpleMain))).ToScriptCoin(redeem));
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 6), new TxOut("0.00250980", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Network.PurpleMain))).ToScriptCoin(redeem));
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 7), new TxOut("0.01000000", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Network.PurpleMain))).ToScriptCoin(redeem));
            transactionBuilder.Send(new Key().PubKey.GetAddress(Network.PurpleMain), "0.01000000");
            transactionBuilder.SetChange(new Key().PubKey.GetAddress(Network.PurpleMain));
        ...
        public void CanBuildTransaction()
        {
            ...
            var destinations = keys.Select(k => k.PubKey.GetAddress(Network.PurpleMain)).ToArray();
        ...
        private static void CanCheckSegwitSigCore(Transaction tx, int input, Money amount, string scriptCodeHex = null)
        {
            ...
            if (scriptCodeHex == null)
            {
                ...
                var param2 = PayToWitPubKeyHashTemplate.Instance.ExtractScriptPubKeyParameters(param1.PublicKey.GetSegwitAddress(Network.PurpleMain).Hash.ScriptPubKey);
        ...
        {
            BitcoinSecret secret = new BitcoinSecret("L5AQtV2HDm4xGsseLokK2VAT2EtYKcTm3c7HwqnJBFt9LdaQULsM", Network.PurpleMain);
        ...
        {
            // test is disabled for now
            // todo: get test data for the Purple blockchain
        ...
        private Transaction[] SetupDummyInputs(CoinsView coinsRet)
        {
            ...
            dummyTransactions[1].Outputs[0].ScriptPubKey = key[2].PubKey.GetAddress(Network.PurpleMain).ScriptPubKey;
            dummyTransactions[1].Outputs[1].Value = 22 * Money.CENT;
            dummyTransactions[1].Outputs[1].ScriptPubKey = key[3].PubKey.GetAddress(Network.PurpleMain).ScriptPubKey;
