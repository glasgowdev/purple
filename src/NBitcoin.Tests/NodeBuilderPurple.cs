...
namespace NBitcoin.Tests
{
        ...
        // Require a Purple node running with the following Purple.conf file
        //server=1
        //rpcuser=rpcuser
    ...
    public class NodeBuilderPurple : IDisposable
    {
        public static NodeBuilderPurple Create([CallerMemberName]string caller = null, string version = "0.12.1")
        {
            ...
            return new NodeBuilderPurple(caller, path);
        }
        ...
        public NodeBuilderPurple(string root, string bitcoindPath)
        {
            this._Root = root;
        ...
        private readonly List<CoreNodePurple> _Nodes = new List<CoreNodePurple>();
        public List<CoreNodePurple> Nodes
        {
            get
            {
                return _Nodes;
        ...
        {
            if (!Process.GetProcesses().Any(p => p.ProcessName.Contains("Purple")))
                throw new NotSupportedException("Purple node is not running");
    ...
    public class CoreNodePurple
    {
        private readonly NodeBuilderPurple _Builder;
        ...
        public CoreNodePurple(string folder, NodeBuilderPurple builder)
        {
            ...
            ports = new int[2];
            FindPorts(ports);
            //ports[1] = Network.PurpleMain.RPCPort;
            //ports[0] = Network.PurpleMain.DefaultPort;
        }
        ...
        {
            return Node.Connect(Network.PurpleMain, "127.0.0.1:" + Network.PurpleMain.DefaultPort); //ports[0].ToString());
        }
