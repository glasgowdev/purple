...
{
    /// <summary>
    /// Light wallet fixed fee policy used for Purple network.
    /// </summary>
    /// <seealso cref="https://github.com/Purpleproject/PurpleX/blob/master/src/wallet.cpp#L1437">PurpleX fee calculation.</seealso>
